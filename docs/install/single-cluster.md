...
export AMP_CHART_VERSION="0.1.5"  # Use your desired version
...
```bash
# Set configuration variables
export OBSERVABILITY_CHART_VERSION="0.1.5"  # Use your desired version
...
```bash
# Set configuration variables
export BUILD_CI_CHART_VERSION="0.1.5"  # Use your desired version
