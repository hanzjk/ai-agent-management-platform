...
AMP_CHART_VERSION="${AMP_CHART_VERSION:-0.0.7}"
BUILD_CI_CHART_VERSION="${BUILD_CI_CHART_VERSION:-0.0.7}"
OBSERVABILITY_CHART_VERSION="${OBSERVABILITY_CHART_VERSION:-0.0.7}"
